...
- Zero emojis in headings (H1, H2, H3) or outline lists (keeps content looking professional, human-written, and non-AI)
...
- **LinkedIn Post (`.dev/social/<article-slug>/linkedin-post.md`)**: Write a highly engaging, scannable post (BLUF format) explaining the technical challenge, trade-offs, and solution. Include the canonical link (`https://devscrolls.dev/articles/<article-slug>/`). NEVER use `.com`.
